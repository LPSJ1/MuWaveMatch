                  ...
                  {showDropdown && (
                    <div className="absolute right-0 top-[calc(100%+8px)] z-50 w-56 rounded-lg border-2 border-gray-900 bg-white p-2 shadow-xl dark:border-slate-600 dark:bg-slate-800">
                      <DropdownItem
                        label="Your Events"
                        onClick={() =>
                          handleNavigation("/profile?section=events")
                        }
                        icon="calendar"
                      />
                      <DropdownItem
                        label="Edit Profile"
                        onClick={() =>
                          handleNavigation("/profile?section=edit")
                        }
                        icon="edit"
                      />
                      <DropdownItem
                        label="Manage Attendees"
                        onClick={() => handleNavigation("/organizer/attendees")}
                        icon="users"
                      />
                      <DropdownItem
                        label="Report an Issue"
                        onClick={() => handleNavigation("/complaints/new")}
                        icon="flag"
                      />
                      {isAdmin && (
                        <DropdownItem
